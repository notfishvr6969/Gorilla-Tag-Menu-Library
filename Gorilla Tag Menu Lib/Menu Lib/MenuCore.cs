        ...
        public static void DrawUpdate(MenuTemplate menu, bool menuStateDepender)
        {
            if (menuStateDepender && menu.menuRoot == null)
            {
                ...
                if (menu.reference == null)
                {
                    ...
                    if (menu.menuPivotPoint == GorillaLocomotion.Player.Instance.rightControllerTransform)
                        menu.reference.transform.parent = GorillaLocomotion.Player.Instance.leftControllerTransform;
                    else
                        menu.reference.transform.parent = GorillaLocomotion.Player.Instance.rightControllerTransform;
